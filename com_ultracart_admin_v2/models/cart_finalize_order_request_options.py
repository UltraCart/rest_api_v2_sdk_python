...
class CartFinalizeOrderRequestOptions(object):
    ...
    def credit_card_authorization_reference_number(self, credit_card_authorization_reference_number):
        ...
        if not credit_card_authorization_reference_number:
            raise ValueError("Invalid value for `credit_card_authorization_reference_number`, must not be `None`")
        if len(credit_card_authorization_reference_number) > 60:
            raise ValueError("Invalid value for `credit_card_authorization_reference_number`, length must be less than `60`")
