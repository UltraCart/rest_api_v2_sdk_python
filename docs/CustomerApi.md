...
> QuickBooksOnlineCustomersResponse get_quick_books_online_customers()
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **q** | **str**| Search query matched against the QuickBooks Online customer display name | [optional]
