...
api_instance = GiftCertificateApi(api_client())
    ...
    try:
        # Establish an auto order by referencing a regular order id
        api_response = api_instance.establish_auto_order_by_reference_order_id(reference_order_id)
        pprint(api_response)
    except ultracart.ApiException as e:
...
api_instance = GiftCertificateApi(api_client())
    ...
    try:
        # Retrieve an auto order by oid
        api_response = api_instance.get_auto_order(auto_order_oid)
        pprint(api_response)
    except ultracart.ApiException as e:
...
api_instance = GiftCertificateApi(api_client())
    ...
    try:
        # Retrieve an auto order by code
        api_response = api_instance.get_auto_order_by_code(auto_order_code)
        pprint(api_response)
    except ultracart.ApiException as e:
...
api_instance = GiftCertificateApi(api_client())
    ...
    try:
        # Retrieve an auto order by order id
        api_response = api_instance.get_auto_order_by_reference_order_id(reference_order_id)
        pprint(api_response)
    except ultracart.ApiException as e:
...
api_instance = GiftCertificateApi(api_client())
    ...
    since = "_since_example" # str | Fetch auto orders that have been created/modified since this date/time. (optional)
    sort = "_sort_example" # str | The sort order of the auto orders.  See Sorting documentation for examples of using multiple values and sorting by ascending and descending. (optional)
    expand = "_expand_example" # str | The object expansion to perform on the result.  See documentation for examples (optional)
...
api_instance = GiftCertificateApi(api_client())
    ...
    ) # AutoOrderQueryBatch | Auto order batch
    expand = "_expand_example" # str | The object expansion to perform on the result. (optional)

    # example passing only required values which don't have defaults set
    try:
        # Retrieve auto order batch
        api_response = api_instance.get_auto_orders_batch(auto_order_batch)
        pprint(api_response)
    except ultracart.ApiException as e:
...
api_instance = GiftCertificateApi(api_client())
    ...
    auto_order_query = AutoOrderQuery(
        ...
        next_shipment_date_begin="next_shipment_date_begin_example",
        next_shipment_date_end="next_shipment_date_end_example",
        original_item_id="original_item_id_example",
        original_order_date_begin="original_order_date_begin_example",
        original_order_date_end="original_order_date_end_example",
        original_order_id="original_order_id_example",
        phone="phone_example",
        postal_code="postal_code_example",
        state="state_example",
        status="status_example",
    ) # AutoOrderQuery | Auto order query
    ...
    try:
        # Retrieve auto orders by query
        api_response = api_instance.get_auto_orders_by_query(auto_order_query)
        pprint(api_response)
    except ultracart.ApiException as e:
...
api_instance = GiftCertificateApi(api_client())
    ...
    auto_order_oid = 1 # int | The auto order oid to pause.
    ...
    try:
        # Pause auto order
        api_response = api_instance.pause_auto_order(auto_order_oid, auto_order)
        pprint(api_response)
    except ultracart.ApiException as e:
    ...
    try:
        # Pause auto order
        api_response = api_instance.pause_auto_order(auto_order_oid, auto_order, expand=expand)
        pprint(api_response)
    except ultracart.ApiException as e:
        print("Exception when calling AutoOrderApi->pause_auto_order: %s\n" % e)
```
...
api_instance = GiftCertificateApi(api_client())
    ...
    try:
        # Update an auto order
        api_response = api_instance.update_auto_order(auto_order_oid, auto_order)
        pprint(api_response)
    except ultracart.ApiException as e:
...
api_instance = GiftCertificateApi(api_client())
    ...
    ) # AutoOrdersRequest | Auto orders to update (synchronous maximum 20 / asynchronous maximum 100)
    expand = "_expand_example" # str | The object expansion to perform on the result.  See documentation for examples (optional)
    ...
    try:
        # Update multiple auto orders
        api_response = api_instance.update_auto_orders_batch(auto_orders_request)
        pprint(api_response)
    except ultracart.ApiException as e:
