...
# **assign_to_affiliate**
> OrderResponse assign_to_affiliate(order_id, assign_to_affiliate_request, expand=expand)
...
order_id = 'order_id_example' # str | The order id to assign to the affiliate.
assign_to_affiliate_request = ultracart.OrderAssignToAffiliateRequest() # OrderAssignToAffiliateRequest | Assign to affiliate request
expand = 'expand_example' # str | The object expansion to perform on the result.  See documentation for examples (optional)

try:
    # Assigns an order to an affiliate
    api_response = api_instance.assign_to_affiliate(order_id, assign_to_affiliate_request, expand=expand)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling OrderApi->assign_to_affiliate: %s\n" % e)
```
...
> block_refund_on_order(order_id, block_reason=block_reason)
...
order_id = 'order_id_example' # str | The order id to block a refund on.
block_reason = 'block_reason_example' # str | Block reason code (optional) (optional)

try:
    # Set a refund block on an order
    api_instance.block_refund_on_order(order_id, block_reason=block_reason)
except ApiException as e:
    print("Exception when calling OrderApi->block_refund_on_order: %s\n" % e)
```
...
order_id = 'order_id_example' # str | The order id to unblock a refund on.

try:
    # Remove a refund block on an order
    api_instance.unblock_refund_on_order(order_id)
except ApiException as e:
    print("Exception when calling OrderApi->unblock_refund_on_order: %s\n" % e)
```
...
validation_request = ultracart.OrderValidationRequest() # OrderValidationRequest | Validation request
