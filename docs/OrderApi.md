...
# **assign_to_affiliate**
> OrderResponse assign_to_affiliate(order_id, assign_to_affiliate_request)
...
> get_accounts_receivable_detail_value_histogram(detail)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **detail** | **str**| The transaction-detail name to histogram. |
 **gateway** | **str**| The gateway name to scope to (optional). | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **order_id** | **str**| The order id to retrieve customer activity for. |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **order_id** | **str**| The order id to retrieve page view history for. |
...
> OrderResponse get_order_upsell_cart(order_id, upsell_cart_request)
...
> OrderResponse held_order_add_items_and_release(order_id, add_items_and_release_request)
...
# **held_order_release**
> OrderResponse held_order_release(order_id)
...
> OrderResponse replace_order_item_merchant_item_id(order_id, replace_order_item_id_request)
