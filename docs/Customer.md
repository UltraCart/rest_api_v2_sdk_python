...
**birth_date** | **str** | Customer birthday | [optional] 
...
**quickbooks_online_customer_id** | **str** | QuickBooks Online customer ID used to lock this customer 1:1 with QuickBooks Online | [optional] 
...
**referral_source** | **str** | Referral Source specified on the wholesale customer signup form.  No other meaning than that signup flow. | [optional] 
