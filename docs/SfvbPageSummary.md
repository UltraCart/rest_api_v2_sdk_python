...
**parent_path** | **str** | Path of the page this one sits under.  Empty for the root page. | [optional] 
**path** | **str** | The page path, beginning and ending with a slash.  The root page is /. | [optional] 
