...
class ConversationAgentStatusHeatmapResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConversationAgentStatusHeatmapResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            agents ([str]): Y-axis labels (one per agent). [optional]  # noqa: E501
            data ([dict]): Sparse cells. Each row is [agent_index, hour, value]; empty cells are omitted.. [optional]  # noqa: E501
            error (Error): [optional]  # noqa: E501
            hours ([int]): X-axis values (hours of day, 0-23). [optional]  # noqa: E501
