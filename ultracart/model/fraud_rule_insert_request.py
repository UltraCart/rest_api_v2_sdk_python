...
class FraudRuleInsertRequest(ModelNormal):
    ...
    attribute_map = {
        ...
        'screen_branding_theme_filters': 'screen_branding_theme_filters',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FraudRuleInsertRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            affiliate_email (str): Affiliate email. Used by the 'affiliate matches' rule type when affiliate_oid is not supplied.. [optional]  # noqa: E501
            affiliate_oid (int): Affiliate OID. Used by the 'affiliate matches' rule type. If omitted, affiliate_email is required.. [optional]  # noqa: E501
            amount_threshold (float): Monetary or score threshold. Used by *transaction amount exceeds*, *fraud score exceeds*, and *decline percentage exceeds* rules.. [optional]  # noqa: E501
            auto_note (str): Note automatically appended to the order's merchant note when this rule fires.. [optional]  # noqa: E501
            avs_match_type (str): AVS match type for the zip portion. Used by the 'address street and zip avs' rule type.. [optional]  # noqa: E501
