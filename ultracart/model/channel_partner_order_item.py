...
class ChannelPartnerOrderItem(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ChannelPartnerOrderItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            arbitrary_unit_cost (float): Arbitrary unit cost for this item that differs from the listed price. [optional]  # noqa: E501
            auto_order_last_rebill_dts (str): Optional date/time of the last rebill if this item is part of an auto (recurring) order. [optional]  # noqa: E501
