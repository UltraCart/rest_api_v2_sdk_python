...
class OrderReplacementItem(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OrderReplacementItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            arbitrary_unit_cost (float): Cost to charge the customer if specified.  If not specified then the default item cost is used.. [optional]  # noqa: E501
