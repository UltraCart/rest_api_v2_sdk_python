...
class CartCheckout(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CartCheckout - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ip_address (str): IP Address (read only unless non-browser key authenticated). [optional]  # noqa: E501
            return_code (str): Return code assigned for send return email operation. [optional]  # noqa: E501
            return_url (str): The URL to redirect the customer to when they return from an abandon cart email.  Must be https protocol.. [optional]  # noqa: E501
            screen_branding_theme_code (str): Screen branding theme code. [optional]  # noqa: E501
            storefront_host_name (str): StoreFront Host Name. [optional]  # noqa: E501
            user_agent (str): User agent of the browser. [optional]  # noqa: E501
        """
