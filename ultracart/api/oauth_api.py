...
class OauthApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.oauth_me_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ultraCartOauth'
                ],
                'endpoint_path': '/oauth/me',
                'operation_id': 'oauth_me',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def oauth_me(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.oauth_me_endpoint.call_with_http_info(**kwargs)
