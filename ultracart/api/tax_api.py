...
class TaxApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_tax_provider_anrok_endpoint = _Endpoint(
            settings={
                'response_type': (TaxProviderAnrok,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/tax/providers/anrok',
                'operation_id': 'get_tax_provider_anrok',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_tax_provider_anrok_test_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/tax/providers/anrok/test',
                'operation_id': 'get_tax_provider_anrok_test',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_tax_provider_anrok_endpoint = _Endpoint(
            settings={
                'response_type': (TaxProviderAnrok,),
                'auth': [
                    'ultraCartOauth',
                ...
                'endpoint_path': '/tax/providers/anrok',
                'operation_id': 'update_tax_provider_anrok',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_tax_provider_anrok(
        self,
        **kwargs
    ):
        """Retrieve the Anrok tax provider  # noqa: E501

        Retrieves the Anrok tax provider.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_tax_provider_anrok(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_tax_provider_anrok_endpoint.call_with_http_info(**kwargs)

    def get_tax_provider_anrok_test(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.get_tax_provider_anrok_test(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_tax_provider_anrok_test_endpoint.call_with_http_info(**kwargs)
    ...
    def update_tax_provider_anrok(
        self,
        tax_provider_anrok,
        **kwargs
    ):
        """Update the Anrok tax provider  # noqa: E501

        Update the Anrok tax provider.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_tax_provider_anrok(tax_provider_anrok, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['tax_provider_anrok'] = \
            tax_provider_anrok
        return self.update_tax_provider_anrok_endpoint.call_with_http_info(**kwargs)
