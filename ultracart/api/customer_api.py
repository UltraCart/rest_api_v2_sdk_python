...
class CustomerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.adjust_loyalty_points_endpoint = _Endpoint(
            settings={
                'response_type': (AdjustLoyaltyPointsResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/customer/customers/{customer_profile_oid}/adjust_loyalty_points',
            ...
            root_map={
                ...
                'location_map': {
                    'customer_profile_oid': 'path',
                    'adjust_loyalty_points_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.get_customer_loyalty_endpoint = _Endpoint(
            settings={
                'response_type': (CustomerLoyaltyResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/customer/customers/{customer_profile_oid}/loyalty',
                'operation_id': 'get_customer_loyalty',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_quick_books_online_customers_endpoint = _Endpoint(
            settings={
                'response_type': (QuickBooksOnlineCustomersResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/customer/quickbooks_online/customers',
                'operation_id': 'get_quick_books_online_customers',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_customer_email_suppression_endpoint = _Endpoint(
            settings={
                'response_type': (CustomerEmailSuppressionResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/customer/customers/{customer_profile_oid}/email_suppression',
                'operation_id': 'update_customer_email_suppression',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def adjust_loyalty_points(
        ...
        **kwargs
        ...
        """Adjusts the loyalty points for a customer by adding a record to the loyalty ledger.  # noqa: E501

        Adjusts the loyalty points for a customer by adding a record to the loyalty ledger.  The loyalty ledger is append only.  Records are never updated or deleted, so a correction is made by posting a second adjustment with the opposite sign.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.adjust_loyalty_points(customer_profile_oid, adjust_loyalty_points_request, async_req=True)
        >>> result = thread.get()

        Args:
            customer_profile_oid (int): The customer profile oid
            adjust_loyalty_points_request (AdjustLoyaltyPointsRequest): adjustLoyaltyPointsRequest
        ...
        kwargs['customer_profile_oid'] = \
            customer_profile_oid
        kwargs['adjust_loyalty_points_request'] = \
            adjust_loyalty_points_request
        return self.adjust_loyalty_points_endpoint.call_with_http_info(**kwargs)
    ...
    def get_customer_loyalty(
        ...
        **kwargs
        ...
        """Retrieve the loyalty points, ledger and redemptions for a customer  # noqa: E501

        Retrieve the loyalty points, ledger and redemptions for a customer.  This is a convenience method that returns the same information as expanding loyalty on the customer object, without having to retrieve the entire customer.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_customer_loyalty(customer_profile_oid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['customer_profile_oid'] = \
            customer_profile_oid
        return self.get_customer_loyalty_endpoint.call_with_http_info(**kwargs)
    ...
    def get_quick_books_online_customers(
        self,
        **kwargs
    ):
        """Search the merchant's QuickBooks Online customers  # noqa: E501

        Typeahead search of the merchant's QuickBooks Online customers by display name.  Used by the customer profile editor to link a profile 1:1 to a QuickBooks Online customer.  Returns up to 100 matches.  If QuickBooks Online is not connected the list will be empty.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_quick_books_online_customers(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_quick_books_online_customers_endpoint.call_with_http_info(**kwargs)
    ...
    def update_customer_email_suppression(
        self,
        customer_profile_oid,
        suppression_changes,
        **kwargs
    ):
        """Clear email suppression for a customer  # noqa: E501

        Clears global unsubscribe, spam complaint and/or bounce suppression for a customer.  This method is clear-only and cannot set a suppression flag.  Clearing a suppression removes the send gate but does not subscribe the customer to any email list -- list membership survives a global unsubscribe untouched, so the customer's original lists become deliverable again with no further action.  Returns 200 with a warning if the flags were cleared but an upstream ESP suppression removal failed; the profile was still modified in that case.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_customer_email_suppression(customer_profile_oid, suppression_changes, async_req=True)
        >>> result = thread.get()

        Args:
            customer_profile_oid (int): The customer profile oid
            suppression_changes (CustomerEmailSuppressionRequest): Suppression changes
        ...
        kwargs['customer_profile_oid'] = \
            customer_profile_oid
        kwargs['suppression_changes'] = \
            suppression_changes
        return self.update_customer_email_suppression_endpoint.call_with_http_info(**kwargs)
