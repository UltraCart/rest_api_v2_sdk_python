...
class WebhookApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_webhook_event_categories_endpoint = _Endpoint(
            settings={
                'response_type': (WebhookEventCategoriesResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/webhook/webhook_event_categories',
                'operation_id': 'get_webhook_event_categories',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_webhook_event_categories(
        ...
        **kwargs
        ...
        """Retrieve webhook event categories  # noqa: E501

        Retrieves the available webhook event categories and events with backend-owned metadata (OIDs, names, descriptions, available expansions, flags) independent of whether any webhooks are saved.  Used by the New Webhook editor so a merchant with zero webhooks can still see the catalog.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_webhook_event_categories(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_webhook_event_categories_endpoint.call_with_http_info(**kwargs)
