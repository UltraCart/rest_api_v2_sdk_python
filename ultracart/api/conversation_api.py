...
class ConversationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_agent_status_config_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ultraCartOauth',
                ...
                'endpoint_path': '/conversation/agent/status/config/{conversation_status_uuid}',
                'operation_id': 'delete_agent_status_config',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_agent_status_configs_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationAgentStatusConfigsResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/agent/status/config',
                'operation_id': 'get_agent_status_configs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_agent_status_heatmap_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationAgentStatusHeatmapResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/agent/status/heatmap',
                'operation_id': 'get_agent_status_heatmap',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_agent_status_summary_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationAgentStatusSummaryResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/agent/status/rollup/summary',
                'operation_id': 'get_agent_status_summary',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_agent_status_timeline_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationAgentStatusTimelineResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/agent/status/history/{agent_user_id}/timeline',
                'operation_id': 'get_agent_status_timeline',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_pbx_default_timezone_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationPbxDefaultTimezoneResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/pbx/config/default-timezone',
                'operation_id': 'get_pbx_default_timezone',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_pbx_pay_connectors_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationPbxPayConnectorsResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/pbx/pay_connector',
                'operation_id': 'get_pbx_pay_connectors',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_pbx_voicemail_capabilities_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationPbxVoicemailCapabilitiesResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/pbx/voicemail/capabilities',
                'operation_id': 'get_pbx_voicemail_capabilities',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.insert_agent_status_config_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationAgentStatusConfigResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/agent/status/config',
                'operation_id': 'insert_agent_status_config',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.search_agent_status_history_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationAgentStatusHistorySearchResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/agent/status/history/search',
                'operation_id': 'search_agent_status_history',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.search_agent_status_rollups_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationAgentStatusRollupSearchResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/conversation/agent/status/rollup/search',
                'operation_id': 'search_agent_status_rollups',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.update_agent_status_config_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationAgentStatusConfigResponse,),
                'auth': [
                    'ultraCartOauth',
                ...
                'endpoint_path': '/conversation/agent/status/config/{conversation_status_uuid}',
                'operation_id': 'update_agent_status_config',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.update_pbx_default_timezone_endpoint = _Endpoint(
            settings={
                'response_type': (ConversationPbxDefaultTimezoneResponse,),
                'auth': [
                    'ultraCartOauth',
                ...
                'endpoint_path': '/conversation/pbx/config/default-timezone',
                'operation_id': 'update_pbx_default_timezone',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def delete_agent_status_config(
        self,
        conversation_status_uuid,
        **kwargs
    ):
        """Soft-deactivate a custom agent status  # noqa: E501

        Sets active=false on the row and the DDB sync record. The Twilio Activity is preserved (Round 2 decision) so historic worker reporting still resolves the SID.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_agent_status_config(conversation_status_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['conversation_status_uuid'] = \
            conversation_status_uuid
        return self.delete_agent_status_config_endpoint.call_with_http_info(**kwargs)
    ...
    def get_agent_status_configs(
        self,
        **kwargs
    ):
        """List custom agent statuses  # noqa: E501

        Returns all custom statuses (active and soft-deactivated) for the merchant.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_agent_status_configs(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_agent_status_configs_endpoint.call_with_http_info(**kwargs)

    def get_agent_status_heatmap(
        self,
        heatmap_request,
        **kwargs
    ):
        """Agent x hour-of-day heatmap  # noqa: E501

        Returns ECharts-shaped agent x hour grid for the requested metric (availability, call_volume, chat_volume). Multi-day requests average the cell values across the date range.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_agent_status_heatmap(heatmap_request, async_req=True)
        >>> result = thread.get()

        Args:
            heatmap_request (ConversationAgentStatusHeatmapRequest): Heatmap request
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['heatmap_request'] = \
            heatmap_request
        return self.get_agent_status_heatmap_endpoint.call_with_http_info(**kwargs)
    ...
    def get_agent_status_summary(
        ...
        **kwargs
        ...
        """Dashboard summary for a date range  # noqa: E501

        Top-line summary: total_agents, avg_available_pct, status_breakdown, per-agent rollups.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_agent_status_summary(date_start2, date_end2, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['date_end2'] = \
            date_end2
        return self.get_agent_status_summary_endpoint.call_with_http_info(**kwargs)

    def get_agent_status_timeline(
        self,
        agent_user_id,
        date2,
        **kwargs
    ):
        """Day timeline for a single agent  # noqa: E501

        Returns merged status events + PBX calls + chat conversations for the agent on the given date. Omitting the channel parameter returns both channels merged.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_agent_status_timeline(agent_user_id, date2, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['agent_user_id'] = \
            agent_user_id
        kwargs['date2'] = \
            date2
        return self.get_agent_status_timeline_endpoint.call_with_http_info(**kwargs)
    ...
    def get_pbx_default_timezone(
        self,
        **kwargs
    ):
        """Get the merchant default timezone  # noqa: E501

        Returns the merchant's stored default timezone (IANA name). Falls back to America/New_York when unset.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_pbx_default_timezone(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_pbx_default_timezone_endpoint.call_with_http_info(**kwargs)
    ...
    def get_pbx_pay_connectors(
        self,
        **kwargs
    ):
        """Get pbx pay connectors  # noqa: E501

        Retrieve the Twilio Pay Connectors installed in the Twilio account for this merchant.  This list is refreshed each time the PBX configuration is deployed.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_pbx_pay_connectors(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_pbx_pay_connectors_endpoint.call_with_http_info(**kwargs)
    ...
    def get_pbx_voicemail_capabilities(
        self,
        **kwargs
    ):
        """Get pbx voicemail capabilities  # noqa: E501

        Retrieve voicemail notification capabilities including available channels   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_pbx_voicemail_capabilities(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_pbx_voicemail_capabilities_endpoint.call_with_http_info(**kwargs)
    ...
    def insert_agent_status_config(
        self,
        status_config,
        **kwargs
    ):
        """Create a custom agent status  # noqa: E501

        Create a custom status. Enforces a 20-active-status-per-merchant cap and the 50-Twilio-Activity-per-workspace cap.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.insert_agent_status_config(status_config, async_req=True)
        >>> result = thread.get()

        Args:
            status_config (ConversationAgentStatusConfig): Status config
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['status_config'] = \
            status_config
        return self.insert_agent_status_config_endpoint.call_with_http_info(**kwargs)
    ...
    def search_agent_status_history(
        self,
        search_request,
        **kwargs
    ):
        """Search agent status history  # noqa: E501

        Paginated search over conversation_agent_status_events_all. Filters: agent_user_id, channel, status, trigger, date range.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_agent_status_history(search_request, async_req=True)
        >>> result = thread.get()

        Args:
            search_request (ConversationAgentStatusHistorySearchRequest): Search request
        ...
        kwargs['search_request'] = \
            search_request
        return self.search_agent_status_history_endpoint.call_with_http_info(**kwargs)

    def search_agent_status_rollups(
        self,
        search_request,
        **kwargs
    ):
        """Search per-(agent, day) rollups  # noqa: E501

        Aggregated over conversation_agent_status_events_all via date_histogram + terms. Returns one row per (agent, day, channel).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_agent_status_rollups(search_request, async_req=True)
        >>> result = thread.get()

        Args:
            search_request (ConversationAgentStatusRollupSearchRequest): Search request
        ...
        kwargs['search_request'] = \
            search_request
        return self.search_agent_status_rollups_endpoint.call_with_http_info(**kwargs)
    ...
    def update_agent_status_config(
        self,
        conversation_status_uuid,
        status_config,
        **kwargs
    ):
        """Update a custom agent status  # noqa: E501

        Update a custom status. Renaming flows through to the Twilio Activity.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_agent_status_config(conversation_status_uuid, status_config, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['status_config'] = \
            status_config
        return self.update_agent_status_config_endpoint.call_with_http_info(**kwargs)
    ...
    def update_pbx_default_timezone(
        self,
        timezone_update,
        **kwargs
    ):
        """Set the merchant default timezone  # noqa: E501

        Persists the IANA timezone on the Config#<merchant_id>/default DDB record (creates on first PUT).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_pbx_default_timezone(timezone_update, async_req=True)
        >>> result = thread.get()

        Args:
            timezone_update (ConversationPbxDefaultTimezoneUpdateRequest): Timezone update
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['timezone_update'] = \
            timezone_update
        return self.update_pbx_default_timezone_endpoint.call_with_http_info(**kwargs)
