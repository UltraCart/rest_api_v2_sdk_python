...
class OrderApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.generate_invoice_endpoint = _Endpoint(
            settings={
                'response_type': (OrderInvoiceResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/order/orders/{order_id}/invoice',
        ...
        self.get_accounts_receivable_detail_value_histogram_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ultraCartOauth',
                ...
                'endpoint_path': '/order/accounts_receivable/detail_value_histogram',
                'operation_id': 'get_accounts_receivable_detail_value_histogram',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_accounts_receivable_gateway_detail_names_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ultraCartOauth',
                ...
                'endpoint_path': '/order/accounts_receivable/gateway_detail_names',
                'operation_id': 'get_accounts_receivable_gateway_detail_names',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_order_customer_activity_endpoint = _Endpoint(
            settings={
                'response_type': (OrderCustomerActivityResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/order/orders/{order_id}/customer_activity',
                'operation_id': 'get_order_customer_activity',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_order_edi_documents_endpoint = _Endpoint(
            settings={
                'response_type': (OrderEdiDocumentsResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
        ...
        self.get_order_page_view_history_endpoint = _Endpoint(
            settings={
                'response_type': (OrderPageViewHistoryResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/order/orders/{order_id}/page_view_history',
                'operation_id': 'get_order_page_view_history',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_order_upsell_cart_endpoint = _Endpoint(
            settings={
                'response_type': (OrderResponse,),
                'auth': [
                    'ultraCartOauth',
                ...
                'endpoint_path': '/order/orders/{order_id}/upsell_with_cart',
                'operation_id': 'get_order_upsell_cart',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.held_order_add_items_and_release_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/order/orders/{order_id}/hold/add_items_and_release',
                'operation_id': 'held_order_add_items_and_release',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'order_id': 'path',
                    'add_items_and_release_request': 'body',
                    'expand': 'query',
                },
                'collection_format_map': {
                }
        ...
        self.held_order_release_endpoint = _Endpoint(
            settings={
                'response_type': (OrderResponse,),
                'auth': [
                    'ultraCartOauth',
                ...
                'endpoint_path': '/order/orders/{order_id}/hold/release',
                'operation_id': 'held_order_release',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def generate_invoice(
        ...
        **kwargs
        ...
        kwargs['order_id'] = \
            order_id
        return self.generate_invoice_endpoint.call_with_http_info(**kwargs)
    ...
    def get_accounts_receivable_detail_value_histogram(
        self,
        detail,
        **kwargs
    ):
        """Retrieve a value histogram for a given AR transaction-detail name  # noqa: E501

        For the calling merchant's Accounts Receivable orders, returns a value -> document-count histogram for the named transaction detail, optionally scoped to transactions on the named gateway. Drives the AR filter modal's autocomplete on the detail-value input.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_accounts_receivable_detail_value_histogram(detail, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['detail'] = \
            detail
        return self.get_accounts_receivable_detail_value_histogram_endpoint.call_with_http_info(**kwargs)

    def get_accounts_receivable_gateway_detail_names(
        self,
        **kwargs
    ):
        """Retrieve gateway / detail-name picker data for the AR filter modal  # noqa: E501

        For the calling merchant's Accounts Receivable orders, returns the distinct payment gateway names paired with the set of transaction-detail names observed on those gateways. Drives the cascading gateway / detail-name pickers in the AR filter modal.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_accounts_receivable_gateway_detail_names(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_accounts_receivable_gateway_detail_names_endpoint.call_with_http_info(**kwargs)
    ...
    def get_order_customer_activity(
        self,
        order_id,
        **kwargs
    ):
        """Retrieve customer activity for this order.  # noqa: E501

        Retrieves the customer activity associated with the email address on this order.  This includes email engagement history, email list and segment membership, lifetime metrics and email suppression status.  A customer profile is not required and is not consulted, so this method works for guest orders that have never had a customer profile established.  For the page views captured during the session that placed the order, see the page view history method instead.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_order_customer_activity(order_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['order_id'] = \
            order_id
        return self.get_order_customer_activity_endpoint.call_with_http_info(**kwargs)

    def get_order_edi_documents(
        self,
        order_id,
        **kwargs
    ):
    ...
    def get_order_page_view_history(
        self,
        order_id,
        **kwargs
    ):
        """Retrieve page view history for this order.  # noqa: E501

        Retrieves the page views captured during the session that placed this order.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_order_page_view_history(order_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['order_id'] = \
            order_id
        return self.get_order_page_view_history_endpoint.call_with_http_info(**kwargs)
    ...
    def get_order_upsell_cart(
        ...
        **kwargs
        ...
        """Get Order Upsell Cart  # noqa: E501

        Creates a new cart using cloned information from the order, but with a specific set of items, coupons and optionally a checkout URL to return the customer to   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_order_upsell_cart(order_id, upsell_cart_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['order_id'] = \
            order_id
        kwargs['upsell_cart_request'] = \
            upsell_cart_request
        return self.get_order_upsell_cart_endpoint.call_with_http_info(**kwargs)
    ...
    def held_order_add_items_and_release(
        ...
        **kwargs
        ...
        >>> thread = api.held_order_add_items_and_release(order_id, add_items_and_release_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['order_id'] = \
            order_id
        kwargs['add_items_and_release_request'] = \
            add_items_and_release_request
        return self.held_order_add_items_and_release_endpoint.call_with_http_info(**kwargs)

    def held_order_release(
        self,
        order_id,
        **kwargs
    ):
        ...
        kwargs['order_id'] = \
            order_id
        return self.held_order_release_endpoint.call_with_http_info(**kwargs)
