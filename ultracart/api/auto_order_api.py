...
class AutoOrderApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.cancel_auto_order_item_by_reference_order_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/auto_order/auto_orders/reference_order_id/{reference_order_id}/items/original/{original_item_id}/cancel',
                'operation_id': 'cancel_auto_order_item_by_reference_order_id',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    ...
                    'original_item_id',
                    'expand',
                    'auto_order_item_cancel_request',
                ],
                'required': [
                    'reference_order_id',
                    'original_item_id',
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'original_item_id': 'path',
                    'expand': 'query',
                    'auto_order_item_cancel_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.get_auto_order_cancel_reasons_endpoint = _Endpoint(
            settings={
                'response_type': (AutoOrderCancelReasonsResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/auto_order/auto_orders/cancel_reasons',
                'operation_id': 'get_auto_order_cancel_reasons',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_auto_order_emails_endpoint = _Endpoint(
            settings={
                'response_type': (AutoOrderEmailsResponse,),
                'auth': [
                    'ultraCartOauth',
                    'ultraCartSimpleApiKey'
                ],
                'endpoint_path': '/auto_order/auto_orders/{auto_order_oid}/emails',
                'operation_id': 'get_auto_order_emails',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def cancel_auto_order_item_by_reference_order_id(
        ...
        **kwargs
        ...
        Keyword Args:
            expand (str): The object expansion to perform on the result.  See documentation for examples. [optional]
            auto_order_item_cancel_request (AutoOrderItemCancelRequest): Cancel request.  Body is optional; omit for default mode=end.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['reference_order_id'] = \
            reference_order_id
        kwargs['original_item_id'] = \
            original_item_id
        return self.cancel_auto_order_item_by_reference_order_id_endpoint.call_with_http_info(**kwargs)
    ...
    def get_auto_order_cancel_reasons(
        ...
        **kwargs
        ...
        """Retrieve auto order cancel reasons.  # noqa: E501

        Retrieves auto order cancel reasons.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_auto_order_cancel_reasons(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_auto_order_cancel_reasons_endpoint.call_with_http_info(**kwargs)

    def get_auto_order_emails(
        self,
        auto_order_oid,
        **kwargs
    ):
        """Retrieve email delivery information for this auto order.  # noqa: E501

        Retrieves email delivery records associated with the specified auto order.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_auto_order_emails(auto_order_oid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['auto_order_oid'] = \
            auto_order_oid
        return self.get_auto_order_emails_endpoint.call_with_http_info(**kwargs)
