...
class Coupon(object):
    ...
    def coupon_type(self, coupon_type):
        ...
        if len(coupon_type) > 65:
            raise ValueError("Invalid value for `coupon_type`, length must be less than `65`")
    ...
    def description(self, description):
        ...
        if len(description) > 50:
            raise ValueError("Invalid value for `description`, length must be less than `50`")
    ...
    def merchant_code(self, merchant_code):
        ...
        if len(merchant_code) > 20:
            raise ValueError("Invalid value for `merchant_code`, length must be less than `20`")
    ...
    def quickbooks_code(self, quickbooks_code):
        ...
        if not quickbooks_code:
            raise ValueError("Invalid value for `quickbooks_code`, must not be `None`")
        if len(quickbooks_code) > 20:
            raise ValueError("Invalid value for `quickbooks_code`, length must be less than `20`")
    ...
    def usable_by(self, usable_by):
        ...
        if not usable_by:
            raise ValueError("Invalid value for `usable_by`, must not be `None`")
        if len(usable_by) > 50:
            raise ValueError("Invalid value for `usable_by`, length must be less than `50`")
