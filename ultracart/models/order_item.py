...
class OrderItem(object):
    ...
    def channel_partner_item_id(self, channel_partner_item_id):
        ...
        if not channel_partner_item_id:
            raise ValueError("Invalid value for `channel_partner_item_id`, must not be `None`")
        if len(channel_partner_item_id) > 30:
            raise ValueError("Invalid value for `channel_partner_item_id`, length must be less than `30`")
    ...
    def country_code_of_origin(self, country_code_of_origin):
        ...
        if not country_code_of_origin:
            raise ValueError("Invalid value for `country_code_of_origin`, must not be `None`")
        if len(country_code_of_origin) > 2:
            raise ValueError("Invalid value for `country_code_of_origin`, length must be less than `2`")
    ...
    def description(self, description):
        ...
        if len(description) > 2000:
            raise ValueError("Invalid value for `description`, length must be less than `2000`")
    ...
    def perishable_class(self, perishable_class):
        ...
        if not perishable_class:
            raise ValueError("Invalid value for `perishable_class`, must not be `None`")
        if len(perishable_class) > 50:
            raise ValueError("Invalid value for `perishable_class`, length must be less than `50`")
    ...
    def quickbooks_class(self, quickbooks_class):
        ...
        if not quickbooks_class:
            raise ValueError("Invalid value for `quickbooks_class`, must not be `None`")
        if len(quickbooks_class) > 31:
            raise ValueError("Invalid value for `quickbooks_class`, length must be less than `31`")
