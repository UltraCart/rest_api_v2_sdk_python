...
from ultracart.exceptions import ApiTypeError, ApiValueError, ApiException
from ultracart.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/4.0.111-RC/python'
